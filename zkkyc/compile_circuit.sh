...
circom ../../circuits/kyc_verifier.circom -l ../../node_modules/circom/circuits/ --r1cs --wasm --sym --c --json || handle_error "Échec de la compilation du circuit"
...
snarkjs powersoftau new bn128 12 pot12_0000.ptau -v || handle_error "Échec de la génération Powers of Tau"

print_step "Contribution à la Phase 1..."
# Première contribution
echo "Contribution random" | snarkjs powersoftau contribute pot12_0000.ptau pot12_0001.ptau --name="Première contribution" -v || handle_error "Échec de la contribution Phase 1"

print_step "Préparation de la Phase 2..."
# Préparer la phase 2
snarkjs powersoftau prepare phase2 pot12_0001.ptau pot12_final.ptau -v || handle_error "Échec de la préparation Phase 2"

print_step "Configuration du circuit..."
# Setup du circuit spécifique
snarkjs groth16 setup kyc_verifier.r1cs pot12_final.ptau kyc_verifier_0000.zkey || handle_error "Échec du setup Groth16"
